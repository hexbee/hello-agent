...
documentation: "https://beui.dev/components/agents/prompt-input"
markdown: "https://beui.dev/components/agents/prompt-input.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/prompt-input
```
...
| `modes` | `PromptMode[]` | `[]` | No | Permission modes displayed in the mode selector. |
| `mode` | `string` | — | No | Controlled permission mode value. |
| `defaultMode` | `string` | — | No | Initial permission mode for uncontrolled usage. |
| `onModeChange` | `((mode: string) => void)` | — | No | Called when the selected permission mode changes. |
...
- Registry detail: https://beui.dev/r/prompt-input
- Raw source: https://beui.dev/r/prompt-input/raw
