...
documentation: "https://beui.dev/components/agents/ai-sidebar"
markdown: "https://beui.dev/components/agents/ai-sidebar.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/ai-sidebar
```
...
- Registry detail: https://beui.dev/r/ai-sidebar
- Raw source: https://beui.dev/r/ai-sidebar/raw
