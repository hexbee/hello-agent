...
documentation: "https://beui.dev/components/agents/tool-approval"
markdown: "https://beui.dev/components/agents/tool-approval.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/tool-approval
```
...
| `status` | `"error" \| "complete" \| "pending" \| "approved" \| "running" \| "approving" \| "denied"` | `pending` | No | — |
| `open` | `boolean` | — | No | — |
...
- Registry detail: https://beui.dev/r/tool-approval
- Raw source: https://beui.dev/r/tool-approval/raw
